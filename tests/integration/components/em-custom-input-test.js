...
test('Input renders with custom css', function(assert) {
  this.render(hbs`{{#em-form as |form|}}{{#form.custom-input label='My label' elementClass="col-md-6" controlWrapper="col-md-8" labelClass="col-md-4" as |mainComponent|}}{{input class=mainComponent.elementClass}}{{/form.custom-input}}{{/em-form}}`);
