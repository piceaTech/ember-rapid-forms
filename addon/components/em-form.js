...
export default Ember.Component.extend({
  ...
  role: 'form',
  form_layout_class: Ember.computed.deprecatingAlias('formLayoutClass', {'id': 'em-form-form_layout_class','until':'v2.0'}),
  ...
  action: 'submit',
  model: null,
  form_layout: Ember.computed.deprecatingAlias('formLayout', {'id': 'em-form-form_layout','until':'v2.0'}),
  formLayout: 'form',
  submit_button: Ember.computed.deprecatingAlias('submitButton', {'id': 'em-form-submit_button','until':'v2.0'}),
  submitButton: true,
  v_icons: Ember.computed.deprecatingAlias('validationIcons', {'id': 'em-form-v_icons','until':'v2.0'}),
